...
app.layout = html.Div(
    children=[
            ...
            [
                html.Div(
                    [
                        ...
                        # Place them next to each other using the CSS style display: flex
                    ],
                    style={"display": "flex"},
                ),
        ...
        # Add Computed graphs
        # we add an empty division with id that will be updated during callback
        html.Div([], id="plot1"),
        html.Div(
            [
                html.Div([], id="plot2"),
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == "OPT1":
        ...
        map_fig.update_layout(
            title_text="Number of flights from origin state", geo_scope="usa" # Plot only the USA instead of globe
        )
